...
class StepMovement(BaseMovement):
    ...
    def detect(self) -> Optional[str]:
        ...
        if self.is_in_motion: # If already stepping, don't detect another step
            return None
        ...
        if not self.is_stable_for_detection and left_foot_is_left and left_foot_distance > self.config.step_threshold:
            _, stability_criterion_name = self._determine_stability_criterion(
                left_foot_distance, left_foot_is_left,
